# 0.4.0 Phase 2 — LangGraph 적용 개발 플랜
...
- **Milestone**: `Phase 4: 0.4.0 Refactoring` (이미 존재, 그대로 사용)
...
> **배포 정책**: 0.4.0 완료 전까지 develop → main PR 과 버전 태그는 사용자가 명시 지시할 때만 실행. Phase 2 머지 후 "정기 배포" 제안 금지.
