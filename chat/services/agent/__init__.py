...
설계 문서: `resources/plans/0.4.0_Phase 7_Agent_개발_설계.md`.
플랜 문서:
- `resources/plans/detail/0.4.0_Phase 7-1_agent_runtime_개발_플랜.md`
- `resources/plans/detail/0.4.0_Phase 7-2_agent_graph_wiring_개발_플랜.md`
"""
